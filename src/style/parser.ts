 ...
 */
export interface StyleParser<T extends ResourceMetadata> {
    ...
    */
   parse(rawCss: string): Resources<ResourceModule, T> | undefined
...
export namespace StyleUtils {
    ...
    */
   export function parse(rawCss: string, options?: CssParseOptions): Resources<ResourceModule, ResourceMetadata> | undefined {
      options = Object.assign({}, {
         cssClass: true,
         cssId: true,
         cssVariable: true,
         convension: "camel",
      } as CssParseOptions, options)
